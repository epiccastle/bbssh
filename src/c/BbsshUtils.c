...
JNIEXPORT jint JNICALL Java_BbsshUtils_is_1a_1tty (JNIEnv *env, jclass this) {
...
JNIEXPORT jint JNICALL Java_BbsshUtils_get_1terminal_1width (JNIEnv *env, jclass this) {
  struct winsize size;
  (void)get_win_size(STDOUT_FILENO, &size);
  return (jint)(size.ws_col);
}

JNIEXPORT jint JNICALL Java_BbsshUtils_get_1terminal_1height (JNIEnv *env, jclass this) {
  struct winsize size;
  (void)get_win_size(STDOUT_FILENO, &size);
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_BbsshUtils_enter_1raw_1mode(JNIEnv *env, jclass this, jint quiet)
{
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_BbsshUtils_leave_1raw_1mode(JNIEnv *env, jclass this, jint quiet)
{
 ...
 */
JNIEXPORT jint JNICALL Java_BbsshUtils_ssh_1open_1auth_1socket (JNIEnv *env, jclass this, jstring path) {
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_BbsshUtils_ssh_1close_1auth_1socket(JNIEnv *env, jclass this, jint socket)
{
  close((int)socket);
}
